...
If submit <> "1" then%>
	...
	' README §39: AxonASP's Eval() cannot resolve DEF_Now here — a module-level global read
	' from inside a routine that has its own locals — and fails the eval unit's COMPILATION
	' with "Variable not defined: 'DEF_Now'", so the whole 徽章 page 500'd for a logged-in
