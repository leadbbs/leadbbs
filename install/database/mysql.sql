...
INSERT INTO `leadbbs_setup` VALUES ('72', '1002', '20140422004', '0', '内部版本号') ON DUPLICATE KEY update valuestr='20130314001';
...
ADD COLUMN `ExpiresTime`  bigint NOT NULL DEFAULT 0 AFTER `Token`,
ADD COLUMN `Retention1`  varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '64' AFTER `ExpiresTime`;

CREATE TABLE IF NOT EXISTS `article_newsarticle` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `article_newsarticle_hide` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT '',
  `content` longtext,
  `classid` bigint(20) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `article_newsclass` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `leadbbs_announce_hide` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `ParentID` bigint(20) DEFAULT '0',
...
INSERT INTO `article_newsclass` VALUES ('1', '公告', '1', '0', '17', '3', '0') ON DUPLICATE KEY update classname=classname;
...
ALTER TABLE `article_newsarticle_hide` ADD COLUMN `htmlflag`  tinyint NOT NULL DEFAULT 2 AFTER `ChildNum`;
CREATE TABLE `LeadBBS_extend` (`ID`  bigint NOT NULL AUTO_INCREMENT ,`ClassType`  int NOT NULL DEFAULT 0 ,`extendID`  bigint NOT NULL DEFAULT 0 ,`extent_title`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,`extent_content`  longtext NULL ,`extent_num`  bigint NOT NULL DEFAULT 0 ,`extent_num2`  bigint NOT NULL DEFAULT 0 ,`extent_level`  int NOT NULL DEFAULT 0 ,PRIMARY KEY (`ID`),INDEX `IX_LeadBBS_extend_extentID` (`ClassType`, `extendID`, `ID`) USING BTREE,INDEX `IX_LeadBBS_extend_level` (`ClassType`, `extent_level`, `ID`) USING BTREE);
CREATE INDEX IX_LeadBBS_User_Truename ON LeadBBS_User(TrueName);
ALTER TABLE `leadbbs_announce` MODIFY COLUMN `LastUser`  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '';
ALTER TABLE `leadbbs_announce_hide` MODIFY COLUMN `LastUser`  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '';
ALTER TABLE `leadbbs_boards` MODIFY COLUMN `LastWriter`  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '';
...
ALTER TABLE `LeadBBS_Boards` ADD COLUMN `BoardIntro2`  longtext CHARACTER SET utf8 COLLATE utf8_general_ci AFTER `OtherLimit`;
ALTER TABLE `LeadBBS_user` ADD COLUMN `remark`  longtext CHARACTER SET utf8 COLLATE utf8_general_ci AFTER `AnnounceNum2`;
ALTER TABLE `leadbbs_applogin` MODIFY COLUMN `Token`  varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '64' AFTER `IPAddress`;
ALTER TABLE `leadbbs_applogin` DROP INDEX `IX_LeadBBS_AppLogin_UserID` , ADD INDEX `IX_LeadBBS_AppLogin_UserID` USING BTREE (`UserID`, `appType`) ;
ALTER TABLE `leadbbs_applogin` ADD INDEX `IX_LeadBBS_AppLogin_appType` (`appType`, `ID`) ;
ALTER TABLE `LeadBBS_User` ADD INDEX `IX_LeadBBS_User_MobileTel` (`MobileTel`, `ID`) ;
