...
function GetPicInfo(LoadFile,typeflag)
	...
	' the poster gets a server error page. See README §44.
...
Function SaveSmallPic(LoadFile,SaveFile,SaveW,SaveH,drawFlag)
	...
	' See GetPicInfo above and README §44: without this the `if err` guard cannot run and a
...
Sub CheckUploadDatabase(BigFile,SmallFile)
	...
	If Rs.Eof Then
		Rs.Close
		Set Rs = Nothing
		' §49: PhotoDir is varchar(100) and this used to receive the ABSOLUTE filesystem path,
