...
Public Sub GetBody(url)
	...
	' string) and a/proxy.asp — which the editor's remote-image fetch and the apijson
	' plug-in both call — answered 500 for every request. Try the versioned name first so
