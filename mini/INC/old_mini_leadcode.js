...
function convertcode(str)
{
	...
	str = str.replace(/\[lrc=(\/|..\/|http:\/\/|ftp:\/\/|https:\/\/|mms:\/\/|rtsp:\/\/)(.+?)\](.+?)\[\/lrc\]/gim,function($0,$1,$2,$3){
		...
		st += '<div style="overflow:hidden;BACKGROUND: #eceded;padding-left:15px;padding-top:2px;BORDER-RIGHT: #b4c2e2 1px solid; BORDER-TOP: #b4c2e2 1px solid; BORDER-LEFT: #b4c2e2 1px solid; height:20px; TEXT-ALIGN: left;FONT-SIZE:9pt;"><div style="float:left">歌词</div> <div style="float:right;margin-right:5px;color:gray;font:11px Arial;font-family:Tahoma;"> LeadBBS lyric 1.01</div></div>';
