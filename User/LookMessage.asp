...
%>
	...
	<tr> 
		<td class="tdbox">
			...
			<br><span class="grayfont">管理员信息：</span><a href='javascript:kill(<%=LngStr(GetData(0,N))%>);'>删除公告</a>，<a href=SendMessage.asp?ModifyMessageID=<%=LngStr(GetData(0,N))%>&pub=1>编辑公告</a>，发布公告人IP：<%=GetData(5,N)%>
		</td>
	</tr><%End If%>
	</table>
	<br>
