...
Function DisplayCenter
	...
	If Num>=0 Then
		...
		Else
			...
			PageSplictString = PageSplictString & " <a href=UserCollect.asp" & EndwriteQueryString & "&Start=" & LngStr(FirstID) & "&UpDownPageFlag=1>上页</a> " & VbCrLf
		End If
		...
		Else
			PageSplictString = PageSplictString & " <a href=UserCollect.asp" & EndwriteQueryString & "&Start=" & LngStr(LastID) & ">下页</a> " & VbCrLf
	...
	If Num <> -1 then
		...
		For n= MinN to MaxN Step StepValue
			...
			If GetData(6,N)>=DEF_TopicContentMaxListNum Then
				Response.Write " [<a href=../a/a.asp?B=" & GetData(7,N) & "&ID=" & LngStr(GetData(10,N)) & "&AUpflag=1&ANum=1 title=" & GetData(2,n) & "字节>" & Temp1 & "</b></a>]"
			End If
