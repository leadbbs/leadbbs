...
Sub DisplayUserAnc
	...
	If Num>=0 Then
		...
		Else
			...
			PageSplictString = PageSplictString & " <a href=""" & RW_User(GBL_ID,"n","",more & "&Start=" & FirstID) & """>上页</a> " & VbCrLf
		End if
		...
		If LastID <= MinRecordID Then
			...
			PageSplictString = PageSplictString & " <a href=""" & RW_User(GBL_ID,"n","",more & "&Start=" & LastID) & """>下页</a> " & VbCrLf
...
Function DisplayUserTopic
	...
	If Num>=0 Then
		...
		If FirstID >= MaxRecordID Then
			...
			PageSplictString = PageSplictString & " <a href=""" & RW_User(GBL_ID,"g","",more & "&Start=" & FirstID & "&UpDownPageFlag=1") & """>上页</a> " & VbCrLf
		end if
		...
		If LastID <= MinRecordID Then
			...
			PageSplictString = PageSplictString & " <a href=""" & RW_User(GBL_ID,"g","",more & "&Start=" & LastID) & """>下页</a> " & VbCrLf
...
Function DisplayAncGood
	...
	If Num>=0 Then
		...
		Else
			...
			PageSplictString = PageSplictString & "<a href=""" & RW_User(GBL_ID,"e","",more & "&Start=" & FirstID & "&UpDownPageFlag=1") & """>上页</a> " & VbCrLf
		End if
		...
		If LastID <= MinRecordID Then
			...
			'PageSplictString = PageSplictString & "尾页 " & VbCrLf
		Else
			PageSplictString = PageSplictString & "<a href=""" & RW_User(GBL_ID,"e","",more & "&Start=" & LastID) & """>下页</a>" & VbCrLf
...
Sub DisplayFriend
	...
	If Num>=0 Then
		...
		If FirstID >= MaxRecordID Then
			...
			PageSplictString = PageSplictString & " <a href=""" & RW_User(GBL_ID,Evol,"",more & "start=" & FirstID & "&UpDownPageFlag=1") & """>上页</a> " & VbCrLf
		end if
		...
		If LastID <= MinRecordID Then
			...
			PageSplictString = PageSplictString & " <a href=""" & RW_User(GBL_ID,Evol,"",more & "start=" & LastID) & """>下页</a> " & VbCrLf
